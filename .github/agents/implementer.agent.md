...
tools:
  ...
  - Grep
handoffs:
  - label: "Continue: test-writer"
    agent: test-writer
    prompt: Continue the pipeline. Read harness/queue/agent-queue.json for context and run the test-writer stage.
    send: false
---

<!-- GENERATED BY `harness sync` — edit harness/agents/implementer.md instead. -->
